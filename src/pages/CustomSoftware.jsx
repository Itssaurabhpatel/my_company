...
const CustomSoftware = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Advanced data processing, analytics, and business intelligence capabilities'
    },
    {
  ...
  const technologies = {
    'Frontend Development': ['React', 'Vue.js', 'Angular', 'TypeScript', 'Next.js'],
    'Backend Systems': ['Node.js', 'Python', 'Java', '.NET Core', 'Spring Boot'],
    'Database & Storage': ['PostgreSQL', 'MongoDB', 'Redis', 'Elasticsearch', 'AWS RDS'],
  ...
  const benefits = [
    {
      ...
      description: 'Automate manual processes and streamline operations for maximum productivity'
    },
    {
    ...
    },
    {
      ...
      description: 'Custom features that differentiate your business in the marketplace'
    },
    {
      icon: <Layers className="w-5 h-5 sm:w-6 sm:h-6" />,
      title: 'System Integration',
      description: 'Seamlessly connect with existing tools and platforms in your ecosystem'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-6 md:mb-8 leading-relaxed font-light tracking-wide">
                Enterprise-grade software solutions engineered to solve complex business challenges, 
                drive digital transformation, and deliver measurable ROI through cutting-edge technology.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
                {[
                  { icon: <Clock className="w-5 h-5 sm:w-6 sm:h-6" />, label: '8-24 Week Delivery' },
                  { icon: <Users className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Dedicated Team' },
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-light px-4">
                Transform your operations and drive growth with custom software solutions 
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="animate-on-scroll opacity-0 translate-y-8">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-8 md:mb-12 lg:mb-16 max-w-3xl mx-auto leading-relaxed font-light tracking-wide px-4">
              Partner with us to create software that drives efficiency, innovation, 
