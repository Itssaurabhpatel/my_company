  ...
  const features = [
    {
      ...
      description: 'Research-driven interfaces that prioritize user needs and behaviors'
    },
    {
      icon: <UserGroup className="w-5 h-5 sm:w-6 sm:h-6" />,
      title: 'User Research & Testing',
      description: 'Comprehensive user research, testing, and data-driven insights'
    },
    {
      icon: <Layout className="w-5 h-5 sm:w-6 sm:h-6" />,
      title: 'Design Systems',
      description: 'Scalable design systems for consistency and maintainability'
    },
    {
      icon: <Magic className="w-5 h-5 sm:w-6 sm:h-6" />,
      title: 'Interactive Prototyping',
      description: 'High-fidelity prototypes for user validation and stakeholder alignment'
    }
  ];

  const technologies = {
    'Design & Prototyping': ['Figma', 'Sketch', 'Adobe XD', 'Framer', 'Principle'],
    'Research & Analytics': ['User Interviews', 'Usability Testing', 'A/B Testing', 'Hotjar', 'Google Analytics'],
    'Design Systems': ['Design Tokens', 'Component Libraries', 'Style Guides', 'Accessibility Standards'],
    'Collaboration': ['Storybook', 'Zeroheight', 'Jira', 'Confluence', 'Miro']
  };
  ...
  const services = [
    {
      ...
      description: 'Comprehensive user research and data-driven design strategies'
    },
    {
      icon: <Smartphone className="w-5 h-5 sm:w-6 sm:h-6" />,
      title: 'UI Design',
      description: 'Pixel-perfect interface design for web and mobile applications'
    },
    {
    ...
    },
    {
      ...
      description: 'User testing and validation to ensure optimal user experiences'
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: 'User research, competitive analysis, and requirement gathering',
      icon: <UserGroup className="w-5 h-5 sm:w-6 sm:h-6" />
    },
    {
      step: '02',
      title: 'Strategy & Planning',
      description: 'Information architecture, user flows, and design strategy',
      icon: <Layout className="w-5 h-5 sm:w-6 sm:h-6" />
    },
    {
      step: '03',
      title: 'Design & Prototyping',
      description: 'Visual design, interaction design, and high-fidelity prototyping',
      icon: <Palette className="w-5 h-5 sm:w-6 sm:h-6" />
    },
    {
      step: '04',
      title: 'Testing & Validation',
      description: 'Usability testing, iteration, and design validation',
      icon: <Eye className="w-5 h-5 sm:w-6 sm:h-6" />
    }
  ];
            ...
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-6 md:mb-8">
                <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-[#FFB400] to-[#FFD700] rounded-2xl sm:rounded-3xl text-slate-900 flex-shrink-0">
                  <Palette className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10" />
                </div>
                <div>
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-6 md:mb-8 leading-relaxed font-light tracking-wide">
                Research-driven design solutions that transform complex business requirements 
                into intuitive, engaging digital experiences that drive user adoption and business growth.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
                {[
                  { icon: <Clock className="w-5 h-5 sm:w-6 sm:h-6" />, label: '4-12 Week Delivery' },
                  { icon: <Users className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Expert Design Team' },
                  { icon: <Target className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Research-Driven Approach' },
                  { icon: <Shield className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Design System Delivery' }
                ].map((stat, index) => (
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-light px-4">
                Comprehensive UI/UX design services that combine user research, 
                strategic thinking, and exceptional visual execution.
              </p>
            </div>
          </div>
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-600 max-w-2xl mx-auto leading-relaxed font-light px-4">
                We leverage industry-leading tools and methodologies to create 
                exceptional user experiences that drive engagement and business results.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-light px-4">
                A structured design methodology that ensures user-centered solutions, 
                stakeholder alignment, and measurable business impact.
              </p>
            </div>
          </div>
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="animate-on-scroll opacity-0 translate-y-8">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-8 md:mb-12 lg:mb-16 max-w-3xl mx-auto leading-relaxed font-light tracking-wide px-4">
              Transform your digital products with research-driven design solutions 
              that drive user engagement and deliver measurable business value.
            </p>
            ...
            >
              <span>START YOUR PROJECT</span>
              <ArrowUpRight className="w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-300" />
            </a>
          </div>
        </div>
      </section>
