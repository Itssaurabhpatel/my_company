...
const WebDevelopment = () => {
  ...
  const features = [
    {
      ...
      description: 'Optimized applications with fast loading times and superior user experience'
    },
    {
      icon: <Cpu className="w-5 h-5 sm:w-6 sm:h-6" />,
      title: 'Progressive Web Apps',
      description: 'Native-like experiences with offline capabilities and mobile optimization'
    },
    {
  ...
  const technologies = {
    'Frontend Development': ['React.js', 'Vue.js', 'Next.js', 'TypeScript', 'Tailwind CSS'],
    'Backend Development': ['Node.js', 'Python Django', 'Laravel', 'Express.js', 'Spring Boot'],
    'Database & Storage': ['PostgreSQL', 'MongoDB', 'Firebase', 'Redis', 'AWS RDS'],
    'Cloud & DevOps': ['AWS', 'Docker', 'Kubernetes', 'CI/CD Pipelines', 'Serverless']
  };
  ...
  const services = [
    {
      ...
      description: 'Dynamic web applications with seamless user interactions and real-time updates'
    },
    {
      icon: <Cloud className="w-5 h-5 sm:w-6 sm:h-6" />,
      title: 'Cloud-Based Solutions',
      description: 'Scalable web applications deployed on robust cloud infrastructure'
    },
    {
    ...
    },
    {
      ...
      description: 'End-to-end solutions from frontend interfaces to backend systems and databases'
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: 'Comprehensive requirements gathering and technical architecture planning',
      icon: <Target className="w-5 h-5 sm:w-6 sm:h-6" />
    },
    {
      step: '02',
      title: 'UI/UX Design',
      description: 'User-centered design and interactive prototyping',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-6 md:mb-8 leading-relaxed font-light tracking-wide">
                Enterprise-grade web applications built with modern architectures, 
                ensuring scalability, performance, and exceptional user experiences that drive business growth.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
                {[
                  { icon: <Clock className="w-5 h-5 sm:w-6 sm:h-6" />, label: '6-16 Week Delivery' },
                  { icon: <Users className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Full-Stack Team' },
                  { icon: <Target className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Agile Methodology' },
                  { icon: <Shield className="w-5 h-5 sm:w-6 sm:h-6" />, label: 'Enterprise Security' }
                ].map((stat, index) => (
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-light px-4">
                Comprehensive web development solutions tailored to meet your specific 
          ...
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-600 max-w-2xl mx-auto leading-relaxed font-light px-4">
                We leverage cutting-edge web technologies and proven frameworks to build 
                scalable, maintainable, and high-performance digital solutions.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16 lg:mb-20">
            <div className="animate-on-scroll opacity-0 translate-y-8">
              ...
              <p className="text-lg sm:text-xl md:text-2xl text-slate-600 max-w-3xl mx-auto leading-relaxed font-light px-4">
                A structured methodology that ensures quality, transparency, and successful delivery 
                at every stage of your web application development.
              </p>
            </div>
          </div>
        ...
        <div className="relative max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <div className="animate-on-scroll opacity-0 translate-y-8">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-slate-300 mb-8 md:mb-12 lg:mb-16 max-w-3xl mx-auto leading-relaxed font-light tracking-wide px-4">
              Transform your vision into a high-performance web application that drives 
              business growth and delivers exceptional user experiences.
            </p>
